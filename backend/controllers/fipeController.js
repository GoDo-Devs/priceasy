...
class FipeController {
    ...
    static async getModelYear(req, res) {
        ...
        try {
            ...
            const years = await fipeService.searchModelYear(vehicleType, brandCode, modelCode);
    ...
    static async getPrice(req, res) {
        ...
        try {
            ...
            const fipePrice = await fipeService.searchFipePrice(vehicleType, brandCode, modelCode, modelYear, fuelType);
